...
# Required.
license.starts_at         = Date.new(2020, 10, 14)
# The date the license expires. 
# Not required, to allow lifetime licenses.
license.expires_at        = Date.new(2099, 10, 15)
